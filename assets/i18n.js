...
(function () {
  ...
  var T = {
    fr: {
      ...
      'about.p1': "Professionnel IT dédié avec une expertise dans la <strong>gestion et la sécurisation d'infrastructures réseaux</strong>, l'<strong>automatisation des processus via scripting</strong> et l'<strong>optimisation des performances systèmes</strong>.",
      'about.p2': "Actuellement en alternance chez <strong>SYSTRA</strong> en tant qu'ingénieur SCCM/Intune, je gère le déploiement et le monitoring de plus de <strong>10 000 appareils</strong>. En parallèle, je finalise mon <strong>diplôme d'ingénieur Réseaux & Sécurité</strong> à ESIEE-IT (promotion 2026).",
      'about.p3': "Reconnu pour mon <strong>adaptabilité</strong>, mon <strong>esprit d'équipe</strong> et ma <strong>communication claire</strong>, j'excelle dans la résolution de challenges complexes tout en assurant des opérations IT fiables et efficaces.",
      ...
      'fp1.res': '<strong>~45 min</strong> de temps de provisioning par poste après optimisation (-88% sur le chemin historique), processus standardisés et déploiements plus fiables sur le périmètre suivi.',
      ...
      'fp3.domain': 'Automatisation IT',
      'fp3.status': 'Lab',
      'fp3.title': 'Provisionnement VM Proxmox via Ansible (IaC)',
      'fp3.pb_label': 'Problème',
      'fp3.pb': "Création manuelle de VMs sur Proxmox = lent, source d'erreur, non reproductible.",
      'fp3.sol_label': 'Solution',
      'fp3.sol': "Playbooks Ansible idempotents : déclaratif YAML, modules Proxmox officiels, variables d'inventaire pour cibler des templates.",
      'fp3.res_label': 'Résultat',
      'fp3.res': "Provisioning à 1 commande, environnements reproductibles, base d'une approche Infrastructure-as-Code.",
      ...
      'pjs.ai2.title': "FlowArchitect AI — Plateforme universelle d'interopérabilité des workflows IA",
      'pjs.ai2.status': 'SaaS · En développement',
      'pjs.ai2.desc': "Plateforme universelle d'interopérabilité de workflows IA et d'automatisation : conversion, analyse, génération et documentation automatique de workflows entre n8n, Make, Zapier et stacks maison. L'objectif : un format pivot et des agents capables d'orchestrer n'importe quelle plateforme.",
    ...
    en: {
      ...
      'about.p1': 'Dedicated IT professional with expertise in <strong>managing and securing network infrastructure</strong>, <strong>process automation through scripting</strong>, and <strong>system performance optimisation</strong>.',
      'about.p2': "Currently a SCCM/Intune apprentice engineer at <strong>SYSTRA</strong>, managing deployment and monitoring across <strong>10,000+ devices</strong>. In parallel, I'm completing my <strong>Network & Security engineering degree</strong> at ESIEE-IT (class of 2026).",
      'about.p3': 'Known for <strong>adaptability</strong>, <strong>teamwork</strong> and <strong>clear communication</strong>, I thrive on untangling complex challenges while keeping IT operations reliable and efficient.',
      ...
      'fp1.res': '<strong>~45 min</strong> of provisioning time per device after optimisation (-88% versus the legacy path), standardised processes and more reliable deployments across the tracked perimeter.',
      ...
      'fp3.domain': 'IT automation',
      'fp3.status': 'Lab',
      'fp3.title': 'Proxmox VM provisioning via Ansible (IaC)',
      'fp3.pb_label': 'Problem',
      'fp3.pb': 'Hand-rolled Proxmox VM creation: slow, error-prone, non-reproducible.',
      'fp3.sol_label': 'Solution',
      'fp3.sol': "Idempotent Ansible playbooks: declarative YAML, official Proxmox modules, inventory variables targeting templates.",
      'fp3.res_label': 'Outcome',
      'fp3.res': "One-command provisioning, reproducible environments, the start of a real Infrastructure-as-Code approach.",
      ...
      'pjs.ai2.title': 'FlowArchitect AI — Universal AI Workflow Interoperability Platform',
      'pjs.ai2.status': 'SaaS · In development',
      'pjs.ai2.desc': "Universal interoperability platform for AI and automation workflows: conversion, analysis, generation and automatic documentation across n8n, Make, Zapier and custom stacks. The goal: a pivot format and agents that can orchestrate any platform.",
