...
(function () {
  ...
  var T = {
    fr: {
      ...
      'hero.metric2.label': "domaines d'expertise",
      ...
      'pjs.filter.all': 'Tous',
      'pjs.filter.ai': 'IA & Agents',
      'pjs.filter.infra': 'Endpoint & Sécurité OS',
      'pjs.filter.net': 'Réseaux',
      'pjs.filter.sec': 'Cybersécurité',
      'pjs.filter.scripts': 'Automatisation / Scripts',
      'pjs.filter.cloud': 'Cloud & Virtualisation',
      'pjs.filter.other': 'Autre',
      ...
      'pjs.orkestra.deck': "Voir le pitch deck",
      ...
      'pjs.voip.title': "Téléphonie sur IP — IPBX Asterisk (SIP)",
      'pjs.voip.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.voip.desc': "Déploiement d'une téléphonie d'entreprise sur deux serveurs Asterisk : enregistrement des utilisateurs SIP, messagerie vocale, routage d'appels et interconnexion des IPBX par trunk SIP, avec analyse des échanges au niveau trame sous Wireshark.",
      'pjs.wifi.title': "Wi-Fi sécurisé WPA2-Enterprise (802.1X / RADIUS)",
      'pjs.wifi.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.wifi.desc': "Architecture Wi-Fi d'entreprise durcie : serveur FreeRADIUS (AAA) sous Linux, point d'accès WPA2-Enterprise via hostapd, client wpa_supplicant, validation par radtest et analyse des attributs RADIUS sous Wireshark — l'accès réseau sécurisé par 802.1X plutôt qu'une clé partagée.",
      'pjs.k8s.title': "Conteneurisation & orchestration — Docker / Kubernetes",
      'pjs.k8s.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.k8s.desc': "Cycle complet d'orchestration de conteneurs sous Kubernetes : namespaces et contextes, déploiement par manifestes YAML, rolling-update, DaemonSets, volumes, exposition par Ingress et contrôle d'accès RBAC. Une compétence cloud-native directement opérationnelle.",
      'pjs.iptables.title': "Automatisation du filtrage iptables par SSH (Python)",
      'pjs.iptables.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.iptables.desc': "Automatisation de l'administration d'un pare-feu Linux : un client Python lit un fichier de règles iptables et les applique à distance via SSH (paramiko), teste le code retour de chaque commande et journalise les résultats. La base concrète d'une logique Infrastructure-as-Code.",
      'pjs.sniffer.title': "Mini-Wireshark — analyseur réseau en Python (raw sockets)",
      'pjs.sniffer.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.sniffer.desc': "Analyseur de trafic réseau écrit en Python pur : capture des trames via raw sockets et décodage manuel des en-têtes (Ethernet, IPv4 et plusieurs protocoles), avec affichage hexdump. Une vraie maîtrise du format des protocoles, au-delà des outils tout faits.",
      'pjs.pentestweb.title': "Pentest applicatif web — Injection SQL & exploitation",
      'pjs.pentestweb.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.pentestweb.desc': "Tests d'intrusion applicatifs web : exploitation d'injections SQL, manipulation de requêtes via Burp Suite et abus d'upload de fichiers jusqu'à la compromission, puis recommandations de remédiation. L'angle applicatif, complémentaire du pentest réseau.",
      'pjs.wazuh.title': "Détection & réponse — XDR Wazuh (blue team)",
      'pjs.wazuh.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.wazuh.desc': "Mise en place d'un XDR Wazuh pour la supervision de sécurité d'un environnement Active Directory : collecte et corrélation d'événements, détection d'intrusion et alerting, avec rapport de sécurité. Le pendant défensif (blue team) des projets de pentest.",
      'pjs.xenomai.title': "Systèmes temps réel sous Xenomai (Linux RT)",
      'pjs.xenomai.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.xenomai.desc': "Ingénierie système temps réel : compilation d'un noyau Linux patché Xenomai Cobalt, mesure et analyse de la latence d'ordonnancement sous charge (visualisation gnuplot), puis applications temps réel multitâches pilotant du GPIO via l'API Alchemy. Une compétence système rare (déterminisme, noyau) appréciée en environnement industriel/embarqué.",
      'pjs.edr.title': "Étude de faisabilité — solution EDR pour PME francophones",
      'pjs.edr.status': "Étude · ESIEE-IT",
      'pjs.edr.desc': "Étude produit/marché d'une solution EDR ciblant les PME francophones : analyse concurrentielle (Microsoft Defender, WatchGuard…), positionnement, cible et contraintes. Un travail à la croisée de la cybersécurité et de la stratégie produit.",
      'pjs.supervision.title': "Supervision réseau — SNMP, Syslog & traps",
      'pjs.supervision.status': "Projet d'ingénieur · ESIEE-IT",
      'pjs.supervision.desc': "Mise en place d'une supervision d'infrastructure : collecte d'état par SNMP et WMI, centralisation des journaux via Syslog et remontée d'alertes par traps. La visibilité opérationnelle nécessaire pour exploiter un parc réseau.",
    ...
    en: {
      ...
      'hero.metric2.label': 'areas of expertise',
      ...
      'pjs.filter.all': 'All',
      'pjs.filter.ai': 'AI & Agents',
      'pjs.filter.infra': 'Endpoint & OS Security',
      'pjs.filter.net': 'Networking',
      'pjs.filter.sec': 'Cybersecurity',
      'pjs.filter.scripts': 'Automation / Scripts',
      'pjs.filter.cloud': 'Cloud & Virtualisation',
      'pjs.filter.other': 'Other',
      ...
      'pjs.orkestra.deck': "View the pitch deck",
      ...
      'pjs.voip.title': "Voice over IP — Asterisk IPBX (SIP)",
      'pjs.voip.status': "Engineering project · ESIEE-IT",
      'pjs.voip.desc': "Enterprise telephony deployed on two Asterisk servers: SIP user registration, voicemail, call routing and IPBX interconnection over a SIP trunk, with frame-level analysis in Wireshark.",
      'pjs.wifi.title': "Secured Wi-Fi — WPA2-Enterprise (802.1X / RADIUS)",
      'pjs.wifi.status': "Engineering project · ESIEE-IT",
      'pjs.wifi.desc': "Hardened enterprise Wi-Fi: FreeRADIUS (AAA) server on Linux, WPA2-Enterprise access point via hostapd, wpa_supplicant client, validation with radtest and RADIUS attribute analysis in Wireshark — network access secured by 802.1X instead of a shared key.",
      'pjs.k8s.title': "Containerisation & orchestration — Docker / Kubernetes",
      'pjs.k8s.status': "Engineering project · ESIEE-IT",
      'pjs.k8s.desc': "Full container-orchestration lifecycle on Kubernetes: namespaces and contexts, YAML-manifest deployments, rolling-update strategies, DaemonSets, volumes, Ingress exposure and RBAC access control. A directly operational cloud-native skill.",
      'pjs.iptables.title': "iptables firewall automation over SSH (Python)",
      'pjs.iptables.status': "Engineering project · ESIEE-IT",
      'pjs.iptables.desc': "Linux firewall administration automated: a Python client reads an iptables rule file and applies it remotely over SSH (paramiko), checks each command's return code and logs the results. The concrete basis of an Infrastructure-as-Code approach.",
      'pjs.sniffer.title': "Mini-Wireshark — Python network sniffer (raw sockets)",
      'pjs.sniffer.status': "Engineering project · ESIEE-IT",
      'pjs.sniffer.desc': "Network traffic analyser written in pure Python: frame capture via raw sockets and manual header decoding (Ethernet, IPv4 and several protocols), with hexdump output. Real mastery of protocol formats, beyond off-the-shelf tools.",
      'pjs.pentestweb.title': "Web app pentest — SQL injection & exploitation",
      'pjs.pentestweb.status': "Engineering project · ESIEE-IT",
      'pjs.pentestweb.desc': "Web application penetration testing: SQL injection exploitation, request tampering with Burp Suite and file-upload abuse leading to compromise, then remediation recommendations. The application-layer counterpart to network pentesting.",
      'pjs.wazuh.title': "Detection & response — Wazuh XDR (blue team)",
      'pjs.wazuh.status': "Engineering project · ESIEE-IT",
      'pjs.wazuh.desc': "A Wazuh XDR deployed to monitor the security of an Active Directory environment: event collection and correlation, intrusion detection and alerting, with a security report. The defensive (blue-team) counterpart to the pentest projects.",
      'pjs.xenomai.title': "Real-time systems with Xenomai (Linux RT)",
      'pjs.xenomai.status': "Engineering project · ESIEE-IT",
      'pjs.xenomai.desc': "Real-time systems engineering: building a Xenomai Cobalt-patched Linux kernel, measuring and analysing scheduling latency under load (gnuplot), then multitasking real-time applications driving GPIO via the Alchemy API. A rare system-level skill (determinism, kernel) valued in industrial/embedded settings.",
      'pjs.edr.title': "Feasibility study — EDR solution for French-speaking SMBs",
      'pjs.edr.status': "Study · ESIEE-IT",
      'pjs.edr.desc': "Product/market study of an EDR solution targeting French-speaking SMBs: competitive analysis (Microsoft Defender, WatchGuard…), positioning, target and constraints. Work at the crossroads of cybersecurity and product strategy.",
      'pjs.supervision.title': "Network monitoring — SNMP, Syslog & traps",
      'pjs.supervision.status': "Engineering project · ESIEE-IT",
      'pjs.supervision.desc': "Infrastructure monitoring set-up: device state collection via SNMP and WMI, log centralisation through Syslog and alerting via traps. The operational visibility required to run a network estate.",
      'pjs.ps.status': "Production · SYSTRA",
